...
# only preferenced 4th and below. Participation measures % of 4th preferences. The rest are random.
PARAMS='--half-participation --nvb --min-preference 6.1'
./sim_lib.sh '4TH-AND-WORSE' 10 2013 "$PARAMS"
